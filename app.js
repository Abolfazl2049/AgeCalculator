...
function expand() {
  if (screen.availWidth < 550) {
    if ((document.querySelector(".container").style.height === "750px")) {
      document.querySelector(".container").style.height = "500px";
      document.querySelector(".img-1").src = "assets/images/arrow_downward_FILL0_wght400_GRAD0_opsz24.svg";
      ...
      document.querySelector(".img-1").src = "assets/images/arrow_upward_FILL0_wght400_GRAD0_opsz24.svg";
